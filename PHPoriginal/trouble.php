...
<html lang="ja">
  ...
  <?php foreach ($result as $row): ?>
    ...
    　<tr><th>カテゴリー : <?php echo h($row['category']) ?></th></tr>
     ...
     <tr><td class="del">
         <a href = "?del=<?=$row['id']?>" onclick = "if(!confirm('この投稿を削除します。宜しいでしょうか？')) return false;">削除</a>
     </td></tr>
     <?php endif; ?>
  ...
  <?php  if(isset($_GET['com'])): ?>
    <?php foreach ($result2 as $row2): ?>
      <table id="comment-t">
        ...
        <tr><th>お名前 : <?php echo h($row2['name']) ?></th></tr>
        <tr><th>コメント</th></tr>
      ...
      <?php else: ?>
        <tr><th>
          <a id="left" href="trouble.php">&ensp;&emsp;コメント閉じる</a>
        </tr></th>
      <?php endif; ?>
    <?php endif; ?>
    </table>
